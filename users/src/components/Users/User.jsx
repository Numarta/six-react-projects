...
export const User = ({id, email, first_name, last_name, avatar, onAddClick, isInvited}) => (
  <li>
    <div>
    ...
    <img onClick={() => onAddClick(id)} className="action" src={`/assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" />
  </li>
);
